...
2. Volunteers could use the app to monitor upcoming events and update status of completed events, as well as submit alerts in realtime on critical issues concerning the beneficiaries (i.e. an elderly feeling unwell, suspected abuse cases and etc).
